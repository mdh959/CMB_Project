...
for i in range(N):
	...
	CEST = (Clphi_est_N)*lls**4/(2*np.pi)#/4 for kappa
	Clphi_est_N[0] = 1.
	CMEAN += CEST
CMEAN /= N
for i in range(N):
...
plt.title("Variance of Auto Power Spectrum")
plt.plot(Ls,D_r_r,label='Theory QE, n = '+str(noiseFactor))
