...
savekappa = '/users/boryanah/Blake/bor_sim/many/sims/kappa_0_1_'+str(myrank)+'.fits'
savekappaest = '/users/boryanah/Blake/bor_sim/many/sims/kappa_est_0_1_'+str(myrank)+'.fits'
...
fname = 'Clphi_0_1_N_'+str(myrank)+'.txt'
...
phi_est = phi_est.filterFromList([ll[1:],filt1[1:]])
phi_cross = phi_cross.filterFromList([ll[1:],filt2[1:]])
