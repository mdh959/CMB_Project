...
savekappa = '/users/boryanah/Blake/bor_sim/many/sims/kappa_0_01_'+str(myrank)+'.fits'
savekappaest = '/users/boryanah/Blake/bor_sim/many/sims/kappa_est_0_01_'+str(myrank)+'.fits'
...
fname = 'Clphi_0_01_N_'+str(myrank)+'.txt'
