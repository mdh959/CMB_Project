...
nametln = '/users/boryanah/Blake/bor_sim/many/sims/Tlens_noise_1_0_'+str(myrank)+'.fits'
namepn = '/users/boryanah/Blake/bor_sim/many/sims/phi_new_'+str(myrank)+'.fits'
savekappa = '/users/boryanah/Blake/bor_sim/many/sims/kappa_1_0_'+str(myrank)+'.fits'
savekappaest = '/users/boryanah/Blake/bor_sim/many/sims/kappa_est_1_0_'+str(myrank)+'.fits'
...
fname = 'Clphi_1_0_N_'+str(myrank)+'.txt'
...
phi_cross.data[:,:] = Fphi_est_unnorm.mapFromFFT()

filt1 = Clphi/Clphi_est
filt2 = Clphi/Clphi_cross
#filt[Larr>2000.] = 0.
#filt[0] = 0.
# here we get more reali-STICK
phi_est = phi_est.filterFromList([ll,filt1])
phi_cross = phi_cross.filterFromList([ll,filt2])

ps2d_est = fftTools.powerFromLiteMap(phi_est)
l, l, ll, Clphi_est, l, l = ps2d_est.binInAnnuli('BIN_200_LOG')

ps2d_cross = fftTools.powerFromLiteMap(phi,phi_cross)
l, l, ll, Clphi_cross, l, l = ps2d_cross.binInAnnuli('BIN_200_LOG')
