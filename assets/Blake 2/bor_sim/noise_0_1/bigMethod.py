...
savef = 'power_filt_subtr_n0_realCl.pdf'
saverat = 'power_rat_filt_subtr_n0_realCl.pdf'
...
lx = Fphi.lx
ly = Fphi.ly
#print ly[100],ly[200],ly[-200];quit()
