...
print phi_e.data
#phi_e.plot(show=False,saveFig = 'phi_e.png',valueRange=[-3.5e-8,-2.8e-8]);plt.close()
...
diff_win = phi.copy()
diff_win.data[:,:] = Fdiff.mapFromFFT() # TRY MAP TOO SMALL FOR THIS #(setMeanToZero=True) # TUKA
