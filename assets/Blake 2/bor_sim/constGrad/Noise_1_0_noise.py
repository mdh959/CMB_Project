...
for i in range(N1,N2):
	namef = 'out_n1_0_noise_'+str(i)+'.txt'
...
for noiseFactor in [1.]:
	...
	plt.semilogy(ellsx,ellsx**2.*((cl['TT_unlen']+numpy.interp(ellsx,ll,nlI))/(13.*10800./np.pi)**2./2/np.pi),label=str(noiseFactor)+'GI')
...
plt.savefig('lensingNoise_1_0_noise.pdf')
