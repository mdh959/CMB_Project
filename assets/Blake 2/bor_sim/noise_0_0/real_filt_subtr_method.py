...
savef = 'power_filt_subtr_n0_0_realCl.pdf'
savefn = 'power_noise_n0_0.pdf'
saverat = 'power_rat_filt_subtr_n0_0_realCl.pdf'
...
#print np.mean(np.sqrt(gradTux.data**2+gradTuy.data**2))
