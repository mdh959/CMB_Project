...
for noiseFactor in [0.01,0.1,1.]:
	...
	# B.H. 
	# for temperature
	plt.semilogy(ellsx,ellsx**2.*((cl['TT_unlen']+numpy.interp(ellsx,ll,nlI))/(12.9*10800./3.14)**2.)/2./numpy.pi,label=str(noiseFactor)+'GI')
...
# temperature
plt.semilogy(ellsx,ellsx**2.*((cl['TT_unlen']+numpy.interp(ellsx,ll,nlI)*0.)/(12.9*10800./3.14)**2.)/2./numpy.pi,label='TT')
# polarization
