...
lls, Clphi, Clphi_est_W, Clphi_cross, yerr = np.loadtxt('noise_0_01_W.txt',unpack=True)
lls, Clphi, Clphi_est, Clphi_cross, yerr = np.loadtxt('noise_0_01_N.txt',unpack=True)
...
plt.savefig('lensingNoise_0_01.pdf')
