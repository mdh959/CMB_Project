...
lls, Clphi, Clphi_est_W, Clphi_cross, yerr = np.loadtxt('noise_1_0_W.txt',unpack=True)
lls, Clphi, Clphi_est, Clphi_cross, yerr = np.loadtxt('noise_1_0_N.txt',unpack=True)
...
plt.savefig('lensingNoise_1_0.pdf')
