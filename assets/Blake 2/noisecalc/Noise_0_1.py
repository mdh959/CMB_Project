...
lls, Clphi, Clphi_est_W, Clphi_cross, yerr = np.loadtxt('noise_0_1_W.txt',unpack=True)
lls, Clphi, Clphi_est, Clphi_cross, yerr = np.loadtxt('noise_0_1_N.txt',unpack=True)
